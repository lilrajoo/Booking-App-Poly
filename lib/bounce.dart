...
// Widget for the Bounce Room Booking screen
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        // Scroll view so that if screen is too small, it can scroll and book, prevent overflow in either web or phone
        child: Padding(
          padding: const EdgeInsets.all(10.0),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.stretch,
            children: [
              // Display bounce image
              SafeArea(
                child: Padding(
                  padding: const EdgeInsets.symmetric(vertical: 3.0),
                  child: Image.asset('images/bounce.png', height: 120.0),
                ),
              ),
              // Date selection options
              Center(
                // For date selection, so it will be in the 3x2 grid
                child: Container(
